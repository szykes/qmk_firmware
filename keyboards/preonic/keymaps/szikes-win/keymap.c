...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_I_II]     = ACTION_TAP_DANCE_DOUBLE(HU_I, HU_IACU),
  [TD_S_I_II]   = ACTION_TAP_DANCE_DOUBLE(S(HU_I), S(HU_IACU)),
...
[_SHIFT] = LAYOUT_preonic_grid( \
  ...
  SHIFT,      S(HU_Y),      S(HU_X),    S(HU_C),      S(HU_V), S(HU_B),  S(HU_N),    S(HU_M),      HU_LABK,      HU_RABK,       S(KC_UP),   HU_QUES,    \
  HU_PLUS,    HU_DQUO,      S(KC_LGUI), S(KC_LALT),   LOWER,   S(KC_SPC), S(KC_SPC), RAISE,        HU_UNDS,      S(KC_LEFT),    S(KC_DOWN), S(KC_RGHT)  \
),
